...
'';
        ...
        ''
        ''
          * * * * * root ${pkgs.moreutils}/bin/chronic ${pkgs.bash} /home/leon/teslamate/bin/health.sh && ${pkgs.curl}/bin/curl -s -m 10 --retry 5 https://hc-ping.com/32aa4c5a-6f71-495e-b3ee-82045498d0c0 >/dev/null
        ''
      ];
  };
